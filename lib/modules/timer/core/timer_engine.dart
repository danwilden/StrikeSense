...
class TimerEngine {
  ...
  Duration get totalRemainingTime {
    ...
    return Duration(milliseconds: math.max(0, 
  ...
  double get progress {
    ...
    return math.max(0.0, math.min(1.0, 
        _elapsedTime.inMilliseconds / totalDuration.inMilliseconds));
  }
  ...
  void _updateCurrentPeriodRemaining() {
    final periodDuration = _isWorkPeriod ? config.workDuration : config.restDuration;
    final periodElapsed = _calculatePeriodElapsed();
    _currentPeriodRemaining = Duration(
      milliseconds: math.max(0, periodDuration.inMilliseconds - periodElapsed.inMilliseconds)
    );
  }
